    ...
    <Paper sx={{display: {xs: 'none', md: 'flex'},
               ...
               <div style={{display: 'flex',
                flexWrap: 'wrap', alignItems: 'center'}}>
                    ...
                    <img style={{
                height: '24vh', width: '100%', display: 'flex',
               ...
               <div style={{display: 'flex',
                flexWrap: 'wrap', alignItems: 'center'}}>
                    ...
                    <img style={{
                height: '24vh', width: '100%', display: 'flex',
                flexWrap: 'wrap', overflow: 'hidden'}}src='https://blog.playo.co/wp-content/uploads/2017/12/shooting-techniques-in-basketball.jpg'/>
